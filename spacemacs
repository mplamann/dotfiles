...
in `dotspacemacs/user-config'."
  ...
  (define-skeleton math-handin
    "LaTeX skeleton for math homework"
    nil
    (with-temp-buffer
      (insert-file-contents "~/.emacs.d/private/math-template.tex")
      (buffer-string)))
  )
